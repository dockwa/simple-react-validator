// Simple React Validator v1.0.5 | Created By Dockwa | MIT License | 2017 - Present
...
function () {
  ...
  _createClass(SimpleReactValidator, [{
    ...
    value: function pass(completion) {
      var index = Object.keys(this.asyncValidators).indexOf(this.asyncValidatorKey);
